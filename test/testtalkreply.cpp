...
public:
    ...
    QScopedPointer<OCC::TalkReply> talkReply;
...
private slots:
    void initTestCase()
    {
        ...
        talkReply.reset(new OCC::TalkReply(accountState.data()));
        ...
        fakeQnam->setOverride([this](QNetworkAccessManager::Operation op, const QNetworkRequest &req, QIODevice *device) {
            ...
            if (path.startsWith(QStringLiteral("/ocs/v2.php/apps/spreed/api/v1/chat")) && replyTo.isEmpty()) {
                reply = new FakePayloadReply(op, req, messageSent, fakeQnam.data());
            } else if (path.startsWith(QStringLiteral("/ocs/v2.php/apps/spreed/api/v1/chat")) && !replyTo.isEmpty()) {
                reply = new FakePayloadReply(op, req, replySent, fakeQnam.data());
            }
